...
using static RemoteAnalyst.Repository.Models.BatchSequenceAlertRecipient;
...
namespace RemoteAnalyst.Repository.Repositories
{
    public class BatchRepository
    {
        ...
        public void CreateBatchTables()
        {
            ...
            try
            {
                NHibernateHelper.CreateTables(_connectionString, typeof(BatchSequenceTrendMap).Assembly);
                NHibernateHelper.CreateTables(_connectionString, typeof(BatchSequenceAlertRecipientMap).Assembly);
                NHibernateHelper.CreateTables(_connectionString, typeof(BatchSequenceAlertProgramMap).Assembly);
                NHibernateHelper.CreateTables(_connectionString, typeof(BatchSequenceProfileMap).Assembly);
            }
            catch (Exception ex)
            {
                _log.Error(ex.StackTrace);
