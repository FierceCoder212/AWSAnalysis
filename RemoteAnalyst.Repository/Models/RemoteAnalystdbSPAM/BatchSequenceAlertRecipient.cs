...
namespace RemoteAnalyst.Repository.Models
{
    public class BatchSequenceAlertRecipient
    {
        ...
        public class BatchSequenceAlertRecipientMap : ClassMap<BatchSequenceAlertRecipient>
        {
            public BatchSequenceAlertRecipientMap()
            {
                Table("BatchSequenceAlertRecipient");
                Id(c => c.BatchSequenceProfileId);
